    ...
    $(document).ready(function () {
        ...
        $(namefield).click(function () {
            if (x <= MaxInputs) {
                ...
                $(InputsWrapper).append('<div>' + '<div class="name box-style" id="InputsWrapper_1' + nameFieldCount + '">' +
                        '<input type="text" name="mytext[]" id="field_' + nameFieldCount + '"/>' + '<input type="hidden" name="mytext[]" value="' + counttext + '"/>' + '<button class="removeclass1">x</button>' +
        ...
        $("body").on("click", ".addclass1", function () {
            ...
            $(this).parent('div').parent('div').append('<div class="name">' + '<input type="text" name="mytext[]" id="field_' +
                    nameFieldCount + '" />' + '<input type="hidden" name="mytext[]" value="' + counttext + '"/>' + '<button class="removeclass1">x</button>' + '<button class="addclass1">+</button>' + '<br>' +
                    '</div>');
            x++;
            return false;
        });
        ...
        $(checkbox).click(function () {
            if (x <= MaxInputs) {
                ...
                $(InputsWrapper).append('<div class="checkbox box-style" id="InputsWrapper_3_' + checkboxdivCount + '">' + '<p class="checkbox_child" id="para' + checkbox_sub_para_Count + '">' +
                        ...
                        checkboxFieldCount++ + '"/>' + '<input type="text" name="checkboxcaption[]" id="captionfield_' + '" value=""/>' + '<input type="hidden" name="checkboxcaption[]" value="' + counttext + '"/>' + '<button class="removeclass3">x</button>' + '<button class="addclass3">+</button>' + '</p>' + '<p class="checkbox_child" id="para' +
                        checkbox_sub_para_Count + '" >' + '<input type="checkbox" name="mycheckbox[]" id="field_' + checkboxFieldCount + '" value="CheckBox' +
                        checkboxFieldCount++ + '"/>' + '<input type="text" name="checkboxcaption[]" id="captionfield_' + '" value=""/>' + '<input type="hidden" name="checkboxcaption[]" value="' + counttext + '"/>' + '<button class="removeclass3">x</button>' + '<button class="addclass3">+</button>' + '</p>' + '<p class="checkbox_child" id="para' +
                        checkbox_sub_para_Count + '" >' +
                        '<input type="checkbox" name="mycheckbox[]" id="field_' + checkboxFieldCount + '" value="CheckBox' + checkboxFieldCount + '"/>' + '<input type="text" name="checkboxcaption[]" id="captionfield_' + '" value=""/>' + '<input type="hidden" name="checkboxcaption[]" value="' + counttext + '"/>' +
